...
func testMigrations1_initDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "test-migrations/1_init.down.sql", size: 0, mode: os.FileMode(493), modTime: time.Unix(1557999818, 0)}
...
func testMigrations1_initUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "test-migrations/1_init.up.sql", size: 0, mode: os.FileMode(493), modTime: time.Unix(1557999818, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func testMigrations2_updateDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "test-migrations/2_update.down.sql", size: 0, mode: os.FileMode(493), modTime: time.Unix(1557999818, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func testMigrations2_updateUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "test-migrations/2_update.up.sql", size: 0, mode: os.FileMode(493), modTime: time.Unix(1557999818, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func testMigrations3_add_columnDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "test-migrations/3_add_column.down.sql", size: 0, mode: os.FileMode(493), modTime: time.Unix(1557999818, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func testMigrations3_add_columnUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "test-migrations/3_add_column.up.sql", size: 0, mode: os.FileMode(493), modTime: time.Unix(1557999818, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
